...
korby_s = pygame.image.load("assets/1000/korby_s.png")
...
pygame.display.set_caption('SuperKorby 3000 premium deluxe remastered edition +')
...
while running == True:
    ...
    window.fill((0,0,0))
    window.blit(bg,(0,0))
    window.blit(ckorby,(900,yk))
    window.blit(lvl1,(xk,0))
